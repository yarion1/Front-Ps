  ...
  return (
    <>
      ...
      <Equipment_RegisterForm>
        <Equipment_Form>
          <legend>
            <b>Formulário de Equipamentos</b>
          </legend>
          <br />
          <br />
          <label for="optionequipment">
            Que tipo de equipamento deseja anunciar?
          </label>
          <br />
          ...
          <br />
          <br />
          <label for="equipmentquali">
            Qual o estado de qualidade do equipamento?
          </label>
          <br />
        ...
        <Button_Register_Send>Enviar</Button_Register_Send>
        <Button_Register_Cancel>Cancelar</Button_Register_Cancel>
      </Equipment_RegisterForm>
    </>
  );
};
